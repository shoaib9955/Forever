    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
              ...
              {token ? (
                <>
                  <p
                    ...
                    className="cursor-pointer hover:text-black hover:bg-gray-200 px-2 py-1 rounded transition-colors"
                  >
                    My Profile
                  </p>
                  <p
        ...
        <div className="group relative">
          ...
          <div
            className={`absolute right-0 top-full mt-2 w-72 sm:w-80 bg-white border border-gray-200 rounded-lg shadow-lg z-50 transition-all duration-200 ${showCartPreview ? "opacity-100 visible" : "opacity-0 invisible"}`}
            onMouseEnter={() => setShowCartPreview(true)}
