    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row  items-center gap-16'>
        ...
        <div className="flex flex-col gap-4 text-gray-600 md:w-2/3">
          <p>Forever was born out of a passion for innovation and a desire to revolutionize the way people shop. Our journey started with a simple idea: to provide a platform where customers can easily discover, explore, and purchase premium products from the comfort of their homes.</p>
          ...
          <p>Our mission at Forever is to empower customers with choice, convenience, and confidence. We strive to provide a seamless shopping experience that exceeds expectations, from browsing and ordering to delivery and beyond.</p>
        </div>
      </div>
